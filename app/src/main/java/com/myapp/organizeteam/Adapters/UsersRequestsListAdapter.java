 ...
 * @since 30-07-2020
 */
public class UsersRequestsListAdapter extends ArrayAdapter<User> {
    ...
    public UsersRequestsListAdapter(@NonNull Context context, int resource, @NonNull ArrayList<User> objects, String teamID) {
